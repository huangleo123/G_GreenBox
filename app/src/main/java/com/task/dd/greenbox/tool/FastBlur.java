...
public class FastBlur {
    ...
    public void blur(ImageView view, Context context){
//获取WallpaperManager 壁纸管理器
        WallpaperManager wallpaperManager = WallpaperManager.getInstance(context); // 获取壁纸管理器
// 获取当前壁纸
